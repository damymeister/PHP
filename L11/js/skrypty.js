...
document.addEventListener('DOMContentLoaded', () => {
    ...
    kont.addEventListener("click", () =>
    {
       ...
       function pokazOnas() 
       {
        fetch("http://localhost/PAI-CW/L11/skrypty/onas.php")
            .then((response) => {
       ...
       function pokazGalerie() {
            fetch("http://localhost/PAI-CW/L11/skrypty/galeria.php")
                .then((response) => {
                     if (response.status !== 200) {
                         return Promise.reject('Coś poszło nie tak!');
                      }
       ...
       {
        fetch("http://localhost/PAI-CW/L11/skrypty/formularz.php")
        .then((response) => {
             if (response.status !== 200) {
                 return Promise.reject('Coś poszło nie tak!');
              }
        ...
        {
        fetch("http://localhost/PAI-CW/L11/skrypty/glowna2.php")
        .then((response) => {
            if (response.status !== 200) {
                return Promise.reject('Coś poszło nie tak!');
            }
